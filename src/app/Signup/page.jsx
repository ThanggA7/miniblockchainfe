...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await signup(formData.username, formData.password, formData.walletAddress);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center px-4 py-6">
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-6 md:p-8">
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">Đăng ký tài khoản</h1>
          <p className="text-sm md:text-base text-gray-600">Tạo tài khoản ZKP mới</p>
        </div>
