...
const UserProfile = () => {
  ...
  const handleUpdateProfile = () => {
    alert("Tính năng cập nhật profile sẽ được phát triển trong phiên bản tiếp theo!");
  };

  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-1">User Profile</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6 space-y-4 md:space-y-0">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-2xl font-bold text-green-600">${(user?.balance || 0).toLocaleString('vi-VN', { minimumFractionDigits: 2 })}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{user?.email || 'demo@zkp.com'}</p>
                  </div>
                <div>
                  <label className="text-sm text-gray-500 block mb-1">User ID (UID)</label>
                  <div className="bg-gray-50 p-3 rounded-lg border">
                    <p className="text-gray-900 font-mono text-sm break-all">{user?.uid || 'N/A'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm text-gray-500 block mb-1">Wallet Type</label>
